...
function aluno(nota1, nota2, nota3){
    ...
    let validador = MediaArit < 5 ? "[REPROVADO]" : "[APROVADO]"
        
    console.log(`${validador}: Nota1: ${nota1}, Nota2: ${nota2}, Nota3: ${nota3}. Maior Nota: ${ReceberNotas[2]}. Média Aritmética ${MediaArit.toFixed(2)} `)
}
